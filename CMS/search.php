    ...
    <div class="container">
        ...
        <div class="row">
            ...
            if(isset($_POST['submit'])){
                ...
                $SEND_search_query = mysqli_query($connection1, $query);

                if(!$SEND_search_query){
                    die("Query Failed: " . mysqli_error($connection1));
                }

                $count = mysqli_num_rows($SEND_search_query);
                if($count == 0){
                    ...
                    while($row = mysqli_fetch_assoc($SEND_search_query)){
